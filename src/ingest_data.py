...
class DataIngestorFactory:
    ...
    def get_data_ingestor(file_extension: str) -> DataIngestor:
        ...
        if file_extension == ".zip":
            ...
            raise ValueError(f"No ingestor avaliable for the extension: {file_extension}")

if __name__ == '__main__':
    # # Specify the file path
    # file_path = "/Users/prana/OneDrive/Desktop/prices-predicition-system/data/archive.zip"
