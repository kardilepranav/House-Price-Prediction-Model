...
# Abstract Base Class for the Data Inspection Strategies
# ------------------------------------------------------
...
# -------------------------------------------
# This Strategy inspects the data type of each column and count
class DataTypesInspectionStrategy(DataInspectionStrategy):
    def inspect(self, df: pd.DataFrame) -> None:
        ...
        Returns: 
        None: Prints the data types and non-null count to the console.
        """
